...
function ReportesMateriales() {
  ...
  const handlePDF = () => {
    const doc = new jsPDF();
    doc.text(`Reporte Mensual de Materiales - ${selectedMonth}`, 14, 20);
    ...
    body.push([
      'Computadoras (Manual)',
      manualData.computadoras.ah, manualData.computadoras.am, manualData.computadoras.dh, manualData.computadoras.dm,
      getTotalFila(manualData.computadoras)
    ]);
    body.push([
        ...
        <div style={{ backgroundColor: 'white', borderRadius: '15px', overflow: 'hidden', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
          <table id="tabla-reporte-biblio" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center' }}>
            ...
            <tbody>
              ...
              <RowItemManual label="Computadoras" objectKey="computadoras" />
